    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <!-- Default form login -->
          <form method="POST" class="text-center border border-light p-5" action="hirelogin.php">
          <?php echo $message;?>
              ...
              <!-- Register -->
              <p>Not a member?
                  <a style="color:rgb(60,60,60)" href="hiresignup.php">Create a Account</a>
              </p>
